...
import com.chanven.lib.cptr.PullAndLoadLayout;
 ...
 * @date 2015-9-21
 */
public class RecyclerViewActivity extends AppCompatActivity implements PtrHandler{
    PullAndLoadLayout ptrClassicFrameLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ptrClassicFrameLayout = (PullAndLoadLayout) this.findViewById(R.id.test_recycler_view_frame);
    ...
    public boolean checkCanDoRefresh(PtrFrameLayout frame, View content, View header) {
        return PullAndLoadLayout.checkContentCanBePulledDown(frame,content,header);
    }
